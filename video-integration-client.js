...
function initVideoForGame(state) {
  ...
  // V9.3.3: Pas de vidéo en mode manuel (cartes physiques)
  if (state.config?.manualRoles) {
    console.log('[Video] Manual mode (physical cards) - skipping video initialization');
    return;
  }
